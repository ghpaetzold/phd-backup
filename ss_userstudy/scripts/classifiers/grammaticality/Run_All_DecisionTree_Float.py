				...
				for k in ks:
					for i in range(1, 6):
						for generator in generators:
							...
							output += 'substitutions_DecisionTreeGrammaticality_'+c+'_'+s+'_'+m+'_'+d+'_'+k+'_'+str(i)+'_all.txt'
							comm = 'nohup python Run_DecisionTree_Float.py '+trainset+' '+k+' '+c+' '+s+' '+m+' '+d+' '+testset
							comm += ' '+output+' &'
							#print(comm)
							os.system(comm)
