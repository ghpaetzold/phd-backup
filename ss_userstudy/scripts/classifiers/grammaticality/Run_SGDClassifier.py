...
print('For training...')
dep_parsed_sents = getParsedSents('/export/data/ghpaetzold/benchmarking/ss_userstudy/corpora/parsed_dep_sents_grammaticality_meaning_training.txt')
fe.temp_resources['dep_parsed_sents'] = dep_parsed_sents
...
print('For testing...')
dep_parsed_sents = getParsedSents('/export/data/ghpaetzold/benchmarking/ss_userstudy/corpora/parsed_dep_sents_lexmturk_all.txt')
fe.temp_resources['dep_parsed_sents'] = dep_parsed_sents
