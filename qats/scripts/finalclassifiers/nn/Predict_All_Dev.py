...
for type in types:
	...
	os.system('mkdir ../../../labels/'+type+'/nn_adadelta_final')
	...
	for model in models:
		...
		embed = model[2]
		ngram = model[3]
		output = '../../../labels/'+type+'/nn_adadelta_final/labels_NeuralNetwork_ADADELTAFINAL_'+hidden+'_'+layer+'_'+embed+'_'+ngram+'.txt'
