...
def getTrainData(corpus, embedsize, ngramsize, m):
	...
	for line in f:
		...
		s2 = data[1]
		label = data[2]
		for ngsize in range(1, ngramsize+1):
...
print('Calculating...')
w2vmodel = '/export/data/ghpaetzold/word2vecvectors/models/word_vectors_all_'+embedsize+'_'+arch
if retro=='1':
	w2vmodel += '_retrofitted'
w2vmodel += '.bin'
...
print('Xtes: ' + str(len(Xtes)))
print('Xte: ' + str(Xtes[0].shape))
