...
fe.addCollocationalFeature('../../corpora/subtleximdb.5gram.bin.unk.txt', 2, 2, 'Simplicity')
...
fe.addSentenceProbabilityFeature('../../corpora/subtleximdb.5gram.bin.unk.txt', 'Simplicity')
