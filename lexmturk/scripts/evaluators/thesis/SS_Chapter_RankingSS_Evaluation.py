...
#Order:
orderss = ['random', 'first', 'lesk', 'wupalmer', 'biran', 'clusters', 'svmrank', 'boundaryCV', 'boundaryUnsupervisedCV']
...
#Data:
dataset = '../../../corpora/lexmturk_all.txt'
lexf = open(dataset)
lex = []
for line in lexf:
...
for index in range(0, len(methods)):
	...
	myt += r'\centering'+'\n'
	#myt += r'\label{table:ssrankvsclass'+str(index)+'}\n'
