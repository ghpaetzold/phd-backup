				...
				for informative in informatives:
					for target in targets:
						for one in ones:
							...
							out += 'substitutions_wordvectorgeneralized_'+proportion+'_'+hasstop+'_'+window+'_'+informative+'_'+target+'_'+one+'.txt'
							comm = 'nohup python Run_WordVectorGeneralized.py ' + generator + ' ' + victor_corpus + ' ' + proportion + ' '
