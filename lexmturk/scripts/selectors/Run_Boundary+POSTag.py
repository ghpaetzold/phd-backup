...
java = '/usr/bin/java'
ps = POSTagSelector(model, tagger, java)
sel_ps = ps.selectCandidates(subs, victor_corpus)
...
selected = bs.selectCandidates(sel_ps, victor_corpus, temp_file, proportion)
