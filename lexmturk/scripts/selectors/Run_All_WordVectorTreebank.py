				...
				for informative in informatives:
					for target in targets:
						for one in ones:
							...
							out += 'substitutions_wordvectortreebank_'+proportion+'_'+hasstop+'_'+window+'_'+informative+'_'+target+'_'+one+'.txt'
							comm = 'nohup python Run_WordVectorTreebank.py ' + generator + ' ' + victor_corpus + ' ' + proportion + ' '
