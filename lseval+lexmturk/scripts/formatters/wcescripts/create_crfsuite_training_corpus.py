...
o = open('../../../corpora/wcefiles/training.txt', 'w')
...
tagged_sents = getTaggedSents('../../../corpora/wcefiles/tagged_sents_cwictor_corpus_fixed.txt')
fe.temp_resources['tagged_sents'] = tagged_sents
features = fe.calculateFeatures('../../../corpora/wcefiles/cwictor_corpus_fixed.txt', format='cwictor')
