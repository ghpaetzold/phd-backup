...
fe.addCollocationalFeature('../../../benchmarking/lexmturk/corpora/brown.5gram.bin.txt', 0, 0, 'Complexity')
...
fe.addSentenceProbabilityFeature('../corpora/lm/subtleximdb/subtleximdb.5gram.unk.bin.txt', 'Complexity')
