...
#fe.addCollocationalFeature('/export/data/ghpaetzold/subtitlesimdb/corpora/100415/corpus.5gram.bin.unk.txt', 2, 2, 'Complexity')
...
fe.addPopCollocationalFeature('/export/data/ghpaetzold/benchmarking/lexmturk/corpora/subtleximdb.5gram.bin.unk.txt', 2, 2, 'Complexity')
