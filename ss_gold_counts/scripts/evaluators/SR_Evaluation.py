...
selectors = ['wordvector', 'boundary', 'boundaryCV', 'svmrank']
...
for method in methods:
		...
		for file in files:
			...
			precision, accuracy, changed = pe.evaluatePipeline('../../corpora/lexmturk_gold.txt', subs)
