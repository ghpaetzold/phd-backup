...
class PaetzoldGenerator:
	...
	def getInitialSet(self, victor_corpus, amount):
		...
		subs_filtered = self.filterSubs(data, subs, candmap, trgs, trgsc, trgsstems, trgscstems, trgslemmas, trgsclemmas)
	...
	def filterSubs(self, data, subs, candmap, trgs, trgsc, trgsstems, trgscstems, trgslemmas, trgsclemmas):
		result = []
		for i in range(0, len(data)):
			d = data[i]
