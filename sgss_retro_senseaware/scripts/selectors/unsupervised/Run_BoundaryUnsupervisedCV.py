...
vector_model = sys.argv[16]
pos_type = sys.argv[17]
...
if pos_type=='paetzold':
        fe.addTaggedWordVectorSimilarityFeature(vector_model, model, tagger, java, 'paetzold', 'Simplicity')
else:
        fe.addWordVectorSimilarityFeature(vector_model, 'Simplicity')
...
tagged_sents = getTaggedSents('../../../../lexmturk/corpora/tagged_sents_lexmturk_all.txt')
