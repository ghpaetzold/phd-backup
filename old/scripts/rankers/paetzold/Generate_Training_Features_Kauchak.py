...
def calculateFeatures(data):
    ...
    lmSubimdb = '../../../../semeval/corpora/lm/subtleximdb/subtleximdb.5gram.unk.bin.txt'
...
ftrainin = open('../../../../semeval/corpora/semeval/semeval_test.txt', 'r')
ftrainout = open('training_features_kauchak_semevaltest.txt', 'w')
