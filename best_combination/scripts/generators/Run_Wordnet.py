...
kg = WordnetGenerator(m, nc, '../evaluators/stanford-postagger-full-2015-04-20/models/english-bidirectional-distsim.tagger', '../evaluators/stanford-postagger-full-2015-04-20/stanford-postagger.jar')
